...
echo "🔧 Bijwerken van BrokerAccounts.jsx met correcte balance parsing..."
...
echo "✅ BrokerAccounts.jsx bijgewerkt. Start nu je frontend opnieuw: cd frontend && npm run dev"
